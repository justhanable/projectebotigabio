...
<!--
    DAW Grup 3
    Vista JSP que permet llistar productes en funció de la categoria
-->
...
<head>
    ...
    <meta name="description" content="Botiga online de productes de proximitat Bio. Pàgina de consulta de tots els nostres products bio i de proximitat.">
