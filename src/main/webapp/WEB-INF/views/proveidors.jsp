...
<head>
    ...
    <meta name="description" content="Botiga online de productes de proximitat Bio. Consulta informació sobre els nostres proveïdors.">
            ...
            <c:forEach var="proveidor" items="${ProveidorsList}">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100">
                        <img class="card-img-top.object-fit: fill" src="<c:url value="${proveidor.proveidorImg}"/>" alt="Imatge de proveïdor">
                       
                        <div class="card-body">
                            <h5 class="card-title">
                                ${proveidor.proveidorNom}<br><br>
                                <b>${proveidor.proveidorCategoria}</b>
                            </h5>
                            <p>${proveidor.proveidorTel}</p>
                            <h5 class="card-text">${proveidor.proveidorZona} </h5>
